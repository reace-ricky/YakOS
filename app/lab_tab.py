...
def render_lab_tab(sport: str) -> None:
    ...
    # Build player name list from pool for multiselect dropdowns
    ...
    # Pre-fill exclude multiselect with previously saved exclusions
    ...
    # Persist exclude selections back to JSON (keeps PGA checkbox editor in sync)
